...
*/
  ...
  //     privateKey.createSHA256Signature(utf8.encode("message") as Uint8List);
  // print("sing");
  //
  // print(base64.encode(signature));
  // bool verified = publicKey.verifySHA256Signature(
  //     AESAlg.convertStringToUint8List("message"), signature);
  // print(verified);
